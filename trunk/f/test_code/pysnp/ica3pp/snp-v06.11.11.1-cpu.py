...
#%%%%%%%%%%%%%%%%%%%
# This is the SNP system CPU only simulator code, which calls an external C program to compute (1)
#%%%%%%%%%%%%%%%%%%%
#
#TODOs:
...
def genCks( allValidSpikVec, sqrMatWidth, configVec_str, allGenCk ) :
	...
	for spikVec in  allValidSpikVec[ 0 ] :
		...
		print ' Before C call time: '
		print str(datetime.now())
		#print  cudaCmd 		
		os.popen( cudaCmd )
		print ' After C call time: '
		print str(datetime.now())
