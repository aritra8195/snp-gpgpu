...
\title{Simulating Spiking Neural P systems without delays using GPGPUs \titlenote{Supported by the \textit{UP Engineering Research and Development for Technology (ERDT)} program}\\}
