...
%
% TODOs:
% 1) add short background on natural computing, examples etc. leading to membrane computing
% 2) add some short background/info on neurons, see Intro of "Spiking Neural P systems and Petri nets" + its references
% 3) explain the SNP figure a bit more
%
